...
async function updateCollectionUI() {
    ...
    collectionStatus.className = `inline-block rounded-full px-4 py-2 text-sm font-semibold ${statusColors[game.status] || "bg-slate-600"} text-white`;
